...
INSERT INTO `__new_active_time`("id", "timestamp", "user_email", "session_id", "type", "duration_sec", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "type", "duration_sec", "app_version" FROM `active_time`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_api_requests`("id", "timestamp", "user_email", "session_id", "model", "cost_usd", "duration_ms", "input_tokens", "output_tokens", "cache_read_tokens", "cache_creation_tokens", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "model", "cost_usd", "duration_ms", "input_tokens", "output_tokens", "cache_read_tokens", "cache_creation_tokens", "app_version" FROM `api_requests`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_cost_usage`("id", "timestamp", "user_email", "session_id", "model", "cost_usd", "skill_name", "plugin_id", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "model", "cost_usd", "skill_name", "plugin_id", "app_version" FROM `cost_usage`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_hook_executions`("id", "timestamp", "user_email", "session_id", "hook_event", "hook_name", "num_hooks", "num_success", "num_blocking", "num_non_blocking_error", "total_duration_ms", "prompt_id", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "hook_event", "hook_name", "num_hooks", "num_success", "num_blocking", "num_non_blocking_error", "total_duration_ms", "prompt_id", "app_version" FROM `hook_executions`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_plugin_events`("id", "timestamp", "event_name", "user_email", "session_id", "plugin_id", "app_version") SELECT "id", "timestamp", "event_name", "user_email", "session_id", "plugin_id", "app_version" FROM `plugin_events`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_session_counts`("id", "timestamp", "user_email", "session_id", "count", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "count", "app_version" FROM `session_counts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_skill_events`("id", "timestamp", "user_email", "session_id", "skill_name", "invocation_trigger", "skill_source", "plugin_id", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "skill_name", "invocation_trigger", "skill_source", "plugin_id", "app_version" FROM `skill_events`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_token_usage`("id", "timestamp", "user_email", "session_id", "model", "token_type", "token_count", "skill_name", "plugin_id", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "model", "token_type", "token_count", "skill_name", "plugin_id", "app_version" FROM `token_usage`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_tool_decisions`("id", "timestamp", "user_email", "session_id", "tool_name", "decision", "source", "prompt_id", "tool_use_id", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "tool_name", "decision", "source", "prompt_id", "tool_use_id", "app_version" FROM `tool_decisions`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_tool_results`("id", "timestamp", "user_email", "session_id", "tool_name", "success", "duration_ms", "prompt_id", "tool_use_id", "app_version") SELECT "id", "timestamp", "user_email", "session_id", "tool_name", "success", "duration_ms", "prompt_id", "tool_use_id", "app_version" FROM `tool_results`;--> statement-breakpoint
